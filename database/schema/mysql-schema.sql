...
CREATE TABLE `files` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `files_share_id_unique` (`share_id`),
  KEY `files_share_id_index` (`share_id`),
  KEY `files_user_id_index` (`user_id`),
  KEY `files_is_public_index` (`is_public`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2025_09_19_044744_create_files_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2025_09_19_115055_create_personal_access_tokens_table',3);
